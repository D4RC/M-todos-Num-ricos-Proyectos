========================================================================
    APLICACIÓN DE CONSOLA: mtd_10_Gauss_Seidel_Jordan Información general del proyecto
========================================================================

AppWizard ha creado esta aplicación mtd_10_Gauss_Seidel_Jordan.

Este archivo contiene un resumen de lo que encontrará en cada uno de los archivos que constituyen la aplicación mtd_10_Gauss_Seidel_Jordan.


mtd_10_Gauss_Seidel_Jordan.vcxproj
...
mtd_10_Gauss_Seidel_Jordan.vcxproj.filters
...
mtd_10_Gauss_Seidel_Jordan.cpp
...
StdAfx.h, StdAfx.cpp
    Estos archivos se usan para compilar un archivo de encabezado precompilado (PCH) denominado mtd_10_Gauss_Seidel_Jordan.pch y un archivo de tipos precompilados llamado StdAfx.obj.
